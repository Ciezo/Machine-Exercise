...
public class ME2 extends JFrame {
    ...
    // SecuyaGridGame instance 
    SecuyaGridGame eventhandler = new SecuyaGridGame(ME2.this); 
    ...
    public ME2(String name) {
        ...
        // SecuyaGridGame listener = new SecuyaGridGame(ME2.this); 
    }

    public void actionCommander() {

        // Collect all component events. Every component has a possible event source.
        // Delagate commands to each 

        // Menu items
        startGame.setActionCommand("startGame"); 
        theme.setActionCommand("theme"); 
        exitGame.setActionCommand("exit"); 
        howToPlay.setActionCommand("howTo");
        about.setActionCommand("about");
        
        // Arrow buttons 
        left.setActionCommand("leftArr"); 
        right.setActionCommand("rightArr");
        up.setActionCommand("upArr");
        down.setActionCommand("downArr");
    ...
    private void addListeners() {
        ...
        // Register UI Components to the ActionListener interface

        // Menu Items 
        startGame.addActionListener(eventhandler); 
        theme.addActionListener(eventhandler);
        exitGame.addActionListener(eventhandler);
        howToPlay.addActionListener(eventhandler);
        about.addActionListener(eventhandler); 

        // Arrow buttons 
        left.addActionListener(eventhandler);
        right.addActionListener(eventhandler);
        up.addActionListener(eventhandler);
        down.addActionListener(eventhandler);

        // Radio button group
        buttonA1.addActionListener(eventhandler);
        buttonA2.addActionListener(eventhandler);
        buttonA3.addActionListener(eventhandler);
        buttonB1.addActionListener(eventhandler);
        buttonB2.addActionListener(eventhandler);
        buttonB3.addActionListener(eventhandler);
        buttonC1.addActionListener(eventhandler);
        buttonC2.addActionListener(eventhandler);
        buttonC3.addActionListener(eventhandler);
        
    }

    // public void actionPerformed(ActionEvent e) {
    //     // TEST
    //     System.out.println("This action is now performed by the listener object");
