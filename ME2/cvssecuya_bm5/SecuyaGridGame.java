...
public class SecuyaGridGame extends JFrame implements ActionListener {
    ...
    private void handleExit(ActionEvent event) {
        ...
        // Since we hid the pop-up window on close notice feature
        // We can directly exit it 
        System.exit(0); 
        gui.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);  

        // HIDE THIS FEATURE TO PASS THE ROBOT SCRIPT
        // Frame instance 
        ...
        // Add action listener to the Exit submenu item 
        // But this causes a delay
        // gui.exitGame.addActionListener(new ActionListener () {
        //     public void actionPerformed(ActionEvent e) {
        //         gui.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);  
        //         System.exit(0); 
        //     }
